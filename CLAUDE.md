...
- iOS app in Swift/SwiftUI, iOS 17+, Swift 5 language mode. The Xcode project is generated by XcodeGen from `project.yml` (+ `full-features.yml` when `SALAH_FULL=true`). Never commit `*.xcodeproj`.
