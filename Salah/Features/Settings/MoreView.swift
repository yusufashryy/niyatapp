    ...
    var body: some View {
        List {
            Section("Home Screen") {
                ...
                step(3, "Search for Salah and pick a widget: Next Prayer, Prayer Times, Verse of the Day or Tasbih.")
            }
            Section("Lock Screen") {
    ...
    private func step(_ number: Int, _ text: String) -> some View {
        HStack(alignment: .top, spacing: 12) {
            Text("\(number)")
                ...
                .background(Color.salahGreen, in: .circle)
    ...
    var body: some View {
        List {
            Section {
                ...
                .padding(.vertical, 4)
                Link(destination: URL(string: "https://github.com/yusufashryy/salahapp")!) {
