        ...
        return VStack(spacing: 28) {
            ...
            ZStack {
                ...
                VStack(spacing: 0) {
                    Image(systemName: "location.north.fill")
                        .font(.system(size: 44))
                        .foregroundStyle(isAligned ? Color.niyatiGold : Color.niyatiGreen)
                    Rectangle()
                        .fill(isAligned ? Color.niyatiGold : Color.niyatiGreen)
            ...
            VStack(spacing: 8) {
                if compass.heading == nil {
                    ...
                    Text("You're facing the Qibla").font(.title2.bold()).foregroundStyle(Color.niyatiGreen)
                } else {
...
private struct CompassDial: View {
    var body: some View {
        ZStack {
            ...
            Circle()
                .stroke(Color.niyatiGreen.opacity(0.3), lineWidth: 2)
