...
struct TodayView: View {
    ...
    private func header(now: Date, next: PrayerTime?) -> some View {
        ...
        .background(.niyatiBackground, in: .rect(cornerRadius: 22))
    }
}
...
private struct PrayerRow: View {
    ...
    var body: some View {
        ...
        .padding(.vertical, 12)
        .background(isCurrent ? Color.niyatiGreen.opacity(0.10) : .clear)
    }
    ...
    private var notificationButton: some View {
        ...
        return Button {
            ...
            Image(systemName: enabled ? "bell.fill" : "bell.slash")
                .foregroundStyle(enabled ? Color.niyatiGreen : .secondary)
                .frame(width: 28)
        }
        .buttonStyle(.plain)
    ...
    private var prayedButton: some View {
        ...
        return Button {
            ...
            Image(systemName: prayed ? "checkmark.circle.fill" : "circle")
                .font(.title3)
                .foregroundStyle(prayed ? Color.niyatiGreen : .secondary)
                .frame(width: 28)
        }
        .buttonStyle(.plain)
